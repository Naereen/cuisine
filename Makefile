...
SSH_HOST=zamok.crans.org
SSH_PORT=22
SSH_USER=besson
SSH_TARGET_DIR=/home/besson/www/cuisine/
...
full:	clean html publish sigal rsync_upload_force clean
all:	clean html rsync_upload clean
...
publish:
	...
	-sed -i.backup s_' "/'_' "'_g $(OUTPUTDIR)/random.html
